...
type Filters struct {
	...
	// max_count is the maximum total messages that user wants to fetch.
	MaxCount uint64 `protobuf:"varint,7,opt,name=max_count,json=maxCount,proto3" json:"max_count,omitempty"`
	// flipped tells whether result messages should be returned in reverse order.
	Flipped bool `protobuf:"varint,8,opt,name=flipped,proto3" json:"flipped,omitempty"`
}
...
func (x *Filters) GetMaxCount() uint64 {
	if x != nil {
		return x.MaxCount
	}
	return 0
...
func (x *Filters) GetFlipped() bool {
	if x != nil {
		return x.Flipped
	}
	return false
...
var file_proto_model_v1_archive_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xfe, 0x01, 0x0a, 0x07, 0x46, 0x69, 0x6c, 0x74,
	...
	0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61, 0x78, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x6d, 0x61, 0x78, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18,
	0x0a, 0x07, 0x66, 0x6c, 0x69, 0x70, 0x70, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x07, 0x66, 0x6c, 0x69, 0x70, 0x70, 0x65, 0x64, 0x42, 0x21, 0x5a, 0x1f, 0x70, 0x6b, 0x67, 0x2f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x2f, 0x3b, 0x61,
	0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
